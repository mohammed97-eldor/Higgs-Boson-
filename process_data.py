...
def main():
    ...
    df_raw = pd.read_csv('./training.csv').set_index('EventId')
    ...
    training.to_csv("./training_processed.csv")
    evaluation.to_csv("./evaluation_processed.csv")
    holdout.to_csv("./holdout_processed.csv")

    # Process the test data
    test_raw = pd.read_csv('./test.csv').set_index('EventId')
